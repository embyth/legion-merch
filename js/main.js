...
(function (global, factory) {
  ...
  var components = [Device$1, Support$1, Browser$1, Resize, Observer$1, Navigation$1, Pagination$1, A11y, Autoplay$1, EffectFade];
...
}, 500); // Height Setter Script For Overlays And Pop-Ups Elements (Inner Pages)

var siteHeaderHeight = document.querySelector('.site-header');
var siteFooterHeight = document.querySelector('.site-footer');
...
window.addEventListener('resize', function () {
  ...
  if (document.body.classList.contains('page--inner')) {
    var cartHeight = viewportHeight - siteHeaderHeight;
...
var searchToggler = document.querySelector('.user-nav__button--search');
var searchBody = document.getElementById('search-pop');
...
var cartToggler = document.querySelector('.user-nav__button--cart');
var cartBody = document.getElementById('cart-pop');
...
var menuBody = document.querySelector('.site-nav');
var menuClose = document.querySelector('.site-nav__close-button');
var menuOverlay = document.querySelector('.site-nav__overlay');
...
var glitchButtons = document.querySelectorAll('.button--glitch');
Array.prototype.forEach.call(glitchButtons, function (el) {
  var content = el.textContent.toUpperCase();
  var attr = document.createAttribute('data-text');
  attr.value = content;
  el.setAttributeNode(attr);
}); // Select Focus Behavior

var selectSize = document.querySelectorAll('.product__size, .form__select');
...
var selectField = document.querySelector('.form__select');
var selectLabel = document.querySelector('.form__label--select');

if (selectField) {
  var selectOptions = selectField.getElementsByTagName('option');
...
var sizeOptions = document.querySelector('.product__size');
...
var messageField = document.getElementById('user-message');

if (messageField) {
  var inputHeight = document.querySelector('input').offsetHeight;
...
function inputErrorHandler() {
  ...
  var form = document.querySelector('.form__form-field');
  ...
  for (var i = 1; i < field.length; i++) {
    Array.from(field, function (el) {
      return el.addEventListener('invalid', function () {
        ...
        el.classList.add('form__input--error'); // Reset invalid state & error message on `input` event, trigger validation check
...
var passwordRestoreBody = document.getElementById('form-restore');
var loginBody = document.getElementById('form-login');
var passwordRestoreCaller = document.querySelector('.form__restore--caller');
var passwordRestoreClose = document.querySelector('.form__restore--close');
...
var tshirtButton = document.getElementById('size-tshirt');
var hoodieButton = document.getElementById('size-hoodie');
var pantsButton = document.getElementById('size-pants');
var tshirtBody = document.getElementById('tshirt-body');
var hoodieBody = document.getElementById('hoodie-body');
var pantsBody = document.getElementById('pants-body');
...
if (sizeSwitch) {
  // Tshirt Section
  var xsTshirtButton = document.getElementById('size-tshirt-xs');
  var xsTshirtRow = document.getElementById('row-tshirt-xs');
  var sTshirtButton = document.getElementById('size-tshirt-s');
  var sTshirtRow = document.getElementById('row-tshirt-s');
  var mTshirtButton = document.getElementById('size-tshirt-m');
  var mTshirtRow = document.getElementById('row-tshirt-m');
  var lTshirtButton = document.getElementById('size-tshirt-l');
  var lTshirtRow = document.getElementById('row-tshirt-l');
  var xlTshirtButton = document.getElementById('size-tshirt-xl');
  var xlTshirtRow = document.getElementById('row-tshirt-xl');
  var xxlTshirtButton = document.getElementById('size-tshirt-xxl');
  var xxlTshirtRow = document.getElementById('row-tshirt-xxl');
  ...
  var xshoodieButton = document.getElementById('size-hoodie-xs');
  var xshoodieRow = document.getElementById('row-hoodie-xs');
  var shoodieButton = document.getElementById('size-hoodie-s');
  var shoodieRow = document.getElementById('row-hoodie-s');
  var mhoodieButton = document.getElementById('size-hoodie-m');
  var mhoodieRow = document.getElementById('row-hoodie-m');
  var lhoodieButton = document.getElementById('size-hoodie-l');
  var lhoodieRow = document.getElementById('row-hoodie-l');
  var xlhoodieButton = document.getElementById('size-hoodie-xl');
  var xlhoodieRow = document.getElementById('row-hoodie-xl');
  var xxlhoodieButton = document.getElementById('size-hoodie-xxl');
  var xxlhoodieRow = document.getElementById('row-hoodie-xxl');
  ...
  var xspantsButton = document.getElementById('size-pants-xs');
  var xspantsRow = document.getElementById('row-pants-xs');
  var spantsButton = document.getElementById('size-pants-s');
  var spantsRow = document.getElementById('row-pants-s');
  var mpantsButton = document.getElementById('size-pants-m');
  var mpantsRow = document.getElementById('row-pants-m');
  var lpantsButton = document.getElementById('size-pants-l');
  var lpantsRow = document.getElementById('row-pants-l');
  var xlpantsButton = document.getElementById('size-pants-xl');
  var xlpantsRow = document.getElementById('row-pants-xl');
  var xxlpantsButton = document.getElementById('size-pants-xxl');
  var xxlpantsRow = document.getElementById('row-pants-xxl');
...
var controlButtons = document.querySelectorAll('.bg-controls__button');
...
var swiper = Swiper;
var init = false; // Which media query

function swiperMode() {
  var mobile = window.matchMedia('(min-width: 0px) and (max-width: 1365px)');
  var aboveMobile = window.matchMedia('(min-width: 1366px)'); // Enable (for mobile)
...
var isIndex = document.querySelector('.page--front');

function swiperIndex() {
  var desktopOnly = window.matchMedia('(min-width: 1366px)');
  var initIndex = false;
